...
const SamsungPurwokerto = lazy(() => import("./pages/SamsungPurwokerto"))
      ...
      <ErrorBoundary>
        <Suspense fallback={null}>
          <Routes>
            ...
            <Route path="/brand/daikin" element={<DaikinPurwokerto />} />
            <Route path="/daikin-purwokerto" element={<Navigate to="/brand/daikin" replace />} />
            <Route path="/brand/gree" element={<GreePurwokerto />} />
            <Route path="/gree-purwokerto" element={<Navigate to="/brand/gree" replace />} />
            <Route path="/brand/midea" element={<MideaPurwokerto />} />
            <Route path="/midea-purwokerto" element={<Navigate to="/brand/midea" replace />} />
            <Route path="/brand/hisense" element={<HisensePurwokerto />} />
            <Route path="/hisense-purwokerto" element={<Navigate to="/brand/hisense" replace />} />
            <Route path="/brand/sansui" element={<SansuiPurwokerto />} />
            <Route path="/sansui-purwokerto" element={<Navigate to="/brand/sansui" replace />} />
            <Route path="/brand/sharp" element={<SharpPurwokerto />} />
            <Route path="/sharp-purwokerto" element={<Navigate to="/brand/sharp" replace />} />
            <Route path="/brand/samsung" element={<SamsungPurwokerto />} />
            <Route path="/samsung-purwokerto" element={<Navigate to="/brand/samsung" replace />} />
            <Route path="/brand/panasonic" element={<PanasonicPurwokerto />} />
            <Route path="/panasonic-purwokerto" element={<Navigate to="/brand/panasonic" replace />} />
            <Route path="/brand/lainnya" element={<BrandLainnya />} />
            <Route path="/ac-inverter-purwokerto" element={<Navigate to="/katalog/ac-inverter" replace />} />
            <Route path="/ac-low-watt-purwokerto" element={<Navigate to="/katalog/ac-low-watt" replace />} />
            <Route path="/ac-purwokerto-selatan" element={<Navigate to="/jual-ac-purwokerto" replace />} />
            <Route path="/instalasi-ac-banyumas" element={<Navigate to="/jual-ac-banyumas" replace />} />
            <Route path="/instalasi-profesional" element={<InstalasiProfesional />} />
            <Route path="/katalog/ac-split-rumah" element={<AcSplitRumah />} />
            <Route path="/katalog/ac-inverter" element={<AcInverter />} />
            <Route path="/katalog/ac-low-watt" element={<AcLowWatt />} />
            <Route path="/katalog/ac-kantor-komersial" element={<AcKantorKomersial />} />
