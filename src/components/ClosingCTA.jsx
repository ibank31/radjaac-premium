...
const CLOSING_MESSAGE =
  "Halo RADJA AC, saya mau cek AC sebelum beli. Mohon bantu cek pilihan PK, brand yang ready, stok, kisaran harga, dan kebutuhan pemasangan berdasarkan ukuran ruangan, daya listrik, lokasi pemasangan, dan budget saya."
      ...
      <div className="relative overflow-hidden rounded-[34px] border border-cyan-300/15 bg-white/[0.035] px-5 py-8 text-center shadow-[0_0_70px_rgba(34,211,238,0.10)] sm:px-8 sm:py-10">
        ...
        <div className="relative mx-auto max-w-2xl">
          ...
          <h2 className="mb-4 text-3xl font-black tracking-[-0.03em] text-white sm:text-4xl">
            Sebelum salah beli AC, kirim data ruangan ke RADJA AC
          </h2>

          <p className="mx-auto mb-7 max-w-xl text-sm leading-7 text-white/65 sm:text-base">
            Kirim ukuran ruangan, daya listrik rumah, foto titik indoor dan outdoor, budget, lokasi pemasangan, dan kapan rencana pasang. Kami bantu arahkan pilihan AC yang masuk akal: PK berapa, brand apa, stok apa yang ready, dan estimasi kebutuhan pasangnya.
          </p>
