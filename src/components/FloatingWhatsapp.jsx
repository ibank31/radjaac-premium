...
export default function FloatingWhatsapp() {
  ...
  return (
    <motion.a
      ...
      className="fixed bottom-[calc(env(safe-area-inset-bottom)+1rem)] right-4 z-50 flex h-12 w-12 items-center justify-center rounded-full bg-[#25D366] shadow-[0_10px_28px_rgba(37,211,102,0.38)] ring-1 ring-white/10 transition-all duration-300 hover:-translate-y-0.5 hover:bg-[#20BA5A] sm:bottom-6 sm:right-6 sm:h-14 sm:w-14"
    >
