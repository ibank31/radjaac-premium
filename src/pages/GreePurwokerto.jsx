    ...
    <div className="min-h-screen overflow-hidden bg-[#050816] text-white">
      ...
      <main>
        <div className="fixed inset-0 -z-10 overflow-hidden">
          <div className="absolute left-[-120px] top-[-220px] h-[360px] w-[360px] rounded-full bg-emerald-500/20 blur-[120px]" />
          ...
          <div className="grid items-start gap-8 lg:grid-cols-2 lg:gap-16">
            <div className="text-center lg:text-left">
              ...
              <div className="mb-5 text-sm text-white/50">
                <Link to="/" className="transition hover:text-emerald-300">Beranda</Link>
        ...
        <section className="mx-auto max-w-7xl px-6 py-8 lg:px-8 lg:py-16">
          <div className="grid items-center gap-7 lg:grid-cols-[0.95fr_1.05fr] lg:gap-10">
            ...
            <div className="overflow-hidden rounded-[34px] border border-emerald-300/20 bg-slate-950/70 p-3 shadow-[0_0_55px_rgba(52,211,153,0.12),0_30px_90px_rgba(8,20,47,0.45)]">
              <img
                src={MURI_IMAGE}
        ...
        <section id="produk-gree" className="mx-auto max-w-7xl px-6 py-8 lg:px-8 lg:py-16">
          ...
          <div className="grid gap-5 md:grid-cols-3">
            {products.map((product) => (
              <article key={product.title} className="group overflow-hidden rounded-[30px] border border-white/10 bg-slate-950/70 shadow-[0_18px_45px_rgba(15,23,42,0.24)] transition hover:-translate-y-1 hover:border-emerald-300/30 hover:bg-white/[0.06]">
                <div className="relative overflow-hidden border-b border-white/10 bg-gradient-to-br from-emerald-400/14 via-slate-900 to-cyan-950/70 p-3">
                  ...
                  />
                  <span className="absolute left-6 top-6 inline-flex rounded-full border border-emerald-300/20 bg-slate-950/70 px-3 py-1 text-xs font-bold text-emerald-100 backdrop-blur">
                    {product.badge}
                  </span>
                </div>
                ...
                <div className="p-6">
                  ...
                  <div className="mb-5 space-y-3 rounded-3xl border border-white/10 bg-white/[0.035] p-4">
                    <div>
                      <p className="text-xs uppercase tracking-[0.18em] text-emerald-200/70">Cocok untuk</p>
                      <p className="mt-1 text-sm font-medium text-white/85">{product.fit}</p>
                    </div>
                    <div>
                      <p className="text-xs uppercase tracking-[0.18em] text-emerald-200/70">Fokus utama</p>
        ...
        <section className="mx-auto max-w-7xl px-6 py-8 lg:px-8 lg:py-16">
          ...
          <div className="overflow-hidden rounded-[28px] border border-white/10 bg-white/[0.04] shadow-[0_18px_45px_rgba(15,23,42,0.18)]">
            <div className="hidden grid-cols-[0.8fr_1fr_1.4fr] border-b border-white/10 bg-emerald-400/10 px-5 py-3 text-xs font-semibold uppercase tracking-[0.18em] text-emerald-200/80 sm:grid">
              <span>Kapasitas</span>
              ...
              {pkGuide.map(([pk, area, note]) => (
                <div key={pk} className="px-5 py-4 sm:grid sm:grid-cols-[0.8fr_1fr_1.4fr] sm:items-center sm:gap-4">
                  <div className="grid grid-cols-[64px_1fr] items-baseline gap-4 sm:contents">
                    <div className="text-xl font-black text-emerald-300 sm:text-xl">{pk}</div>
