...
const areaConfig = {
  ...
  seoDescription:
    "RADJA AC melayani konsultasi pembelian AC area Cilacap untuk unit only, banyak unit, toko, kost, ruko, kantor, dan opsi pemasangan sesuai lokasi.",
  ...
  bulkPurchase: {
    ...
    title: "Butuh AC untuk toko, kost, ruko, kantor, atau usaha area Cilacap?",
    description:
    ...
    cards: [
      ...
      ["Kost & Banyak Unit", "Bantu cek kebutuhan beberapa ruangan, stok unit, pilihan brand, estimasi pengiriman, dan jadwal."],
    ],
  ...
  processDescription:
    "Pembelian AC area Cilacap perlu dikonfirmasi dulu berdasarkan lokasi detail, jumlah unit, kebutuhan unit only atau opsi pasang, stok, rute, dan kondisi titik pemasangan. Ini penting supaya estimasi tidak meleset.",
  processSteps: [
    ["Kirim lokasi detail & jumlah unit", "Sebutkan area Cilacap/Kroya/Maos/sekitarnya, jumlah unit, kebutuhan unit only atau opsi pasang, jenis ruangan, ukuran ruangan, daya listrik, dan budget."],
  ...
  finalCtaDescription:
    "Kirim lokasi detail, jumlah unit, kebutuhan unit only atau opsi pasang, jenis ruangan, ukuran ruangan, daya listrik, dan budget. RADJA AC bantu cek stok, rekomendasi PK, estimasi harga, opsi pengiriman, dan jadwal sesuai konfirmasi.",
}
