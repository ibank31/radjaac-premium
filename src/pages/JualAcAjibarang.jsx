...
const WA_MESSAGE =
  "Halo RADJA AC, saya dari area Ajibarang. Mau tanya AC yang bisa COD/bayar di tempat. Mohon bantu cek stok, harga, rekomendasi PK, dan estimasi pemasangan AC."

const ajibarangAreas = [
  "Ajibarang",
  "Ajibarang Kulon",
  "Ajibarang Wetan",
  "Pancasan",
...
const buyerNeeds = [
  ...
  ["Toko, kantor & cafe", "Cek kebutuhan AC untuk ruang usaha, area pelanggan, ruang kerja, dan tempat usaha sekitar Ajibarang.", Building2],
  ["Kos, kontrakan & proyek kecil", "Bisa konsultasi beberapa unit, stok, jadwal, dan kebutuhan pemasangan bertahap.", Store],
]

const processSteps = [
  ["Kirim lokasi & ukuran ruangan", "Sebutkan area Ajibarang, ukuran ruangan, daya listrik, dan foto titik indoor-outdoor jika ada."],
...
const faqItems = [
  [
    "Apakah RADJA AC melayani jual AC area Ajibarang?",
    "Ya. RADJA AC berbasis di Purwokerto dan melayani konsultasi pembelian AC untuk area Ajibarang dan sekitarnya. Untuk pengiriman dan pemasangan, jadwal serta biaya menyesuaikan lokasi dan kondisi pekerjaan.",
  ],
  [
    "Apakah bisa beli AC area Ajibarang dengan COD?",
...
function WhatsAppButton({ children = "Konsultasi AC Area Ajibarang", className = "" }) {
  return (
    <a
...
export default function JualAcAjibarang() {
  ...
  const localBusinessSchema = {
    ...
    url: `${SITE_DATA.baseUrl}/jual-ac-ajibarang`,
    ...
    areaServed: ajibarangAreas.map((area) => ({ "@type": "City", name: area })),
  }

  return (
    <div className="min-h-screen overflow-hidden bg-[#050816] text-white">
      <SeoHead
        title="Jual AC Ajibarang Bisa COD | Stok & Pemasangan — RADJA AC"
        description="RADJA AC melayani jual AC area Ajibarang dan sekitarnya. Bisa konsultasi stok, harga, rekomendasi PK, estimasi pemasangan, dan opsi COD/bayar di tempat sesuai konfirmasi."
      ...
      <main>
          ...
          <div className="grid items-center gap-10 lg:grid-cols-[1.04fr_0.96fr] lg:gap-16">
            <div>
              ...
              <p className="mb-6 max-w-2xl text-sm leading-7 text-white/70 sm:text-base">
                RADJA AC Purwokerto melayani pembelian AC untuk area Ajibarang dan sekitarnya. Konsultasi stok, harga, rekomendasi PK, estimasi pemasangan, dan opsi COD/bayar di tempat sesuai konfirmasi lokasi, jadwal, serta kondisi pekerjaan.
              </p>
              <div className="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center">
                <WhatsAppButton>Tanya AC COD Ajibarang</WhatsAppButton>
            ...
            <div className="relative mx-auto w-full max-w-[500px] lg:mr-0">
              <div className="overflow-hidden rounded-[34px] border border-white/10 bg-slate-950/75 p-3 shadow-[0_30px_90px_rgba(8,20,47,0.42)]">
                <img
                  ...
                  alt="Showroom RADJA AC untuk konsultasi jual AC Ajibarang"
                  fetchPriority="high"
                  decoding="async"
        ...
        <section className="mx-auto max-w-7xl px-6 py-10 lg:px-8 lg:py-16">
          <SectionTitle
            ...
            title="Beli AC area Ajibarang bisa lebih tenang"
        ...
        <section className="mx-auto max-w-7xl px-6 py-10 lg:px-8 lg:py-16">
          <SectionTitle
            ...
            description="Untuk area Ajibarang, konsultasi awal penting agar pembelian AC tidak hanya mengejar harga, tetapi juga sesuai kapasitas ruangan, listrik, dan rencana pemasangan."
          />
        ...
        <section className="mx-auto max-w-7xl px-6 py-10 lg:px-8 lg:py-16">
          <div className="grid gap-6 lg:grid-cols-2">
            <div className="rounded-[32px] border border-white/10 bg-white/[0.04] p-6 sm:p-8">
              ...
              <h2 className="mb-4 text-3xl font-black tracking-[-0.03em]">Cari harga AC area Ajibarang?</h2>
            ...
            <div className="rounded-[32px] border border-white/10 bg-white/[0.04] p-6 sm:p-8">
              ...
              <ul className="space-y-3 text-sm leading-7 text-white/62 sm:text-base">
                {[
                  "Area/lokasi pemasangan di Ajibarang",
        ...
        <section className="mx-auto max-w-7xl px-6 py-10 lg:px-8 lg:py-16">
          <SectionTitle eyebrow="FAQ" title="Pertanyaan umum jual AC Ajibarang" />
        ...
        <section className="mx-auto max-w-7xl px-6 pb-16 pt-10 lg:px-8 lg:pb-24 lg:pt-16">
          <div className="rounded-[34px] border border-[#25D366]/20 bg-[#25D366]/10 p-6 text-center sm:p-10 lg:p-14">
            <h2 className="mx-auto mb-5 max-w-3xl text-3xl font-black tracking-[-0.03em] sm:text-4xl lg:text-5xl">Mau beli AC area Ajibarang dengan COD?</h2>
