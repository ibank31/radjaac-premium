      ...
      <main>
        ...
        <section className="mx-auto max-w-7xl px-6 py-10 lg:px-8 lg:py-16">
                ...
                <article key={aspect} className="rounded-[22px] border border-white/10 bg-slate-950/45 p-4">
                  ...
                  <div className="grid gap-2">
                    <div className="rounded-2xl border border-white/10 bg-white/[0.035] p-3">
                      <p className="mb-1 text-[11px] font-bold uppercase tracking-[0.18em] text-white/45">Non-Inverter</p>
                      <p className="text-sm leading-6 text-white/70">{non}</p>
                    </div>
                    <div className="rounded-2xl border border-cyan-300/20 bg-cyan-300/10 p-3">
                      <p className="mb-1 text-[11px] font-bold uppercase tracking-[0.18em] text-cyan-200">Inverter</p>
                      <p className="text-sm font-semibold leading-6 text-white/90">{inv}</p>
                    </div>
                  </div>
                </article>
              ))}
          ...
          <div className="hidden overflow-hidden rounded-[28px] border border-white/10 bg-white/[0.04] shadow-[0_18px_45px_rgba(15,23,42,0.18)] sm:block">
            <div className="grid grid-cols-[0.75fr_1fr_1fr] border-b border-white/10 bg-cyan-400/10 px-5 py-3 text-xs font-semibold uppercase tracking-[0.18em] text-cyan-200/80">
              <span>Aspek</span>
            ...
            <div className="divide-y divide-white/10">
              {comparison.map(([aspect, non, inv]) => (
                <div key={aspect} className="grid grid-cols-[0.75fr_1fr_1fr] gap-4 px-5 py-4">
                  <div className="text-sm font-black text-cyan-300">{aspect}</div>
                  <div className="text-sm leading-6 text-white/60">{non}</div>
