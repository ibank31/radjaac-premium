        ...
        <section className="rounded-[32px] border border-white/10 bg-slate-950/70 p-8 md:p-12 shadow-[0_24px_80px_rgba(8,20,47,0.55)]">
          ...
          <div className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr]">
            <div className="space-y-8">
              <section className="rounded-[32px] border border-cyan-400/20 bg-slate-900/90 p-8 shadow-[0_0_60px_rgba(14,116,144,0.16)]">
                <h2 className="text-2xl font-semibold text-white mb-4">WhatsApp Contact</h2>
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="inline-flex w-full items-center justify-center gap-3 rounded-full bg-[#25D366] px-8 py-4 text-lg font-semibold text-slate-950 shadow-[0_24px_60px_rgba(37,211,102,0.24)] transition duration-300 hover:-translate-y-0.5 hover:bg-[#20BA5A]"
                >
              ...
              <section className="rounded-3xl border border-white/10 bg-slate-900/80 p-8">
                <h2 className="text-2xl font-semibold text-white mb-4">Jam Operasional</h2>
              ...
              <section className="rounded-3xl border border-white/10 bg-slate-900/80 p-8">
                ...
                <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3 text-slate-200">
                  {[
                    "Purwokerto",
                    "Banyumas",
                    "Sokaraja",
                    ...
                    <div key={area} className="rounded-3xl border border-white/10 bg-slate-950/70 px-4 py-3">
                      {area}
                    </div>
                  ))}
                </div>
            ...
            <aside className="rounded-[32px] border border-cyan-400/20 bg-gradient-to-br from-slate-950/80 via-slate-900/80 to-cyan-500/10 p-8 shadow-[0_30px_80px_rgba(8,20,47,0.65)] flex flex-col justify-between gap-8">
              <div>
                <h2 className="text-2xl font-semibold text-white mb-4">Tempatkan Google Maps bisnis di section ini</h2>
                ...
                <div className="h-72 rounded-[28px] border border-white/10 bg-slate-950/70 p-6 flex items-center justify-center text-center text-slate-400">
                  <div>
                    <p className="font-semibold text-white mb-2">Peta Lokasi</p>
                    <p>Tempatkan Google Maps bisnis di section ini</p>
                  </div>
                </div>
              </div>

              <div className="rounded-[28px] border border-white/10 bg-slate-950/80 p-8 shadow-[0_0_60px_rgba(14,116,144,0.18)]">
                <p className="text-cyan-300 uppercase tracking-[0.2em] text-xs mb-3">Butuh Bantuan Segera?</p>
                <h3 className="text-white text-2xl font-bold mb-4">Konsultasi WhatsApp untuk jadwal dan estimasi</h3>
                <p className="text-slate-300 leading-relaxed mb-6">Hubungi kami melalui WhatsApp untuk konfirmasi jadwal layanan AC dan estimasi biaya yang cepat.</p>
                <a
                  href="https://wa.me/62882008246099"
                  target="_blank"
                  rel="noreferrer"
