...
const areaConfig = {
  ...
  bulkPurchase: {
    eyebrow: "UNIT ONLY & KEBUTUHAN USAHA",
    title: "Butuh AC untuk toko, ruko, kost, kantor, atau kontraktor area Tegal?",
    description:
      "Untuk Tegal, konsultasi diarahkan ke kebutuhan pengadaan unit: jumlah AC, tipe ruangan, brand incaran, dan target budget. RADJA AC bantu cek stok, rekomendasi PK, harga beberapa unit, opsi pengiriman, dan kemungkinan pemasangan bila lokasi serta jadwal memungkinkan.",
    cards: [
      ["Unit Only", "Cocok untuk kontraktor, teknisi lokal, pengelola kost, toko, ruko, atau pembeli yang butuh unit saja."],
    ...
    waMessage:
      "Halo RADJA AC, saya dari Tegal. Mau konsultasi pembelian AC banyak unit untuk toko/ruko/kost/kantor. Mohon bantu cek stok, pilihan brand, harga, dan opsi pengiriman.",
  },
