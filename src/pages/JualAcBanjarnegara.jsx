...
const areaConfig = {
  ...
  waMessage:
    "Halo RADJA AC, saya dari area Banjarnegara. Mau konsultasi pembelian AC.",
  ...
  bulkPurchase: {
    ...
    waMessage:
      "Halo RADJA AC, saya dari area Banjarnegara. Mau konsultasi pembelian AC banyak unit untuk toko/kost/ruko/kantor/proyek. Mohon bantu cek stok, rekomendasi PK, estimasi harga, pengiriman, dan jadwal pemasangan.",
  },
